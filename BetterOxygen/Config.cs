...
public class Config
{
    ...
    public Config(ConfigFile cfg)
    {
        ...
        oxygenRefillRate = cfg.Bind("Extra Options", "Oxygen Refill Rate (seconds/second):", defaultValue: 0.1f, "Controls the rate at which oxygen refills while standing inside the diving bell, in seconds of O2 gained per second inside the bell");
    }
}
